...
<?php
    ...
    $select =   "select * from drzave
                 WHERE id_drz='".$_GET['id']."'";
    ...
    $sql = "update drzave set
        naziv='".$Naziv."',
        skr_oznaka='".$SkrOznaka."',
        addedby='".$AddedBy."'
        where id_drz='".$_GET['id']."' LIMIT 1";
   ...
   <div class="row">
        <div class="col-md-12">
            <div class="page-header">
                <h2>Šifarnik - države: izmjeni zapis</h2>
            </div>
        </div>
    </div>
    <div class="container-fluid">
                    ...
                    <form enctype="multipart/form-data" method="post" class="form-horizontal">
                        <fieldset>
                            ...
                            <label class="col-md-2 control-label" for="naziv">Naziv:</label>
                                <div class="col-md-3">
                                    <input id="naziv" name="naziv" type="text" value = "<?php echo $Naziv;?>" placeholder="Naziv države" class="form-control input-md" required><span class='asterisc'>*</span>
                                </div>
                            </div>
                            <!-- Skraćena oznaka -->
                            <div class="form-group">
                            <label class="col-md-2 control-label" for="skr_oznaka">Skraćena oznaka:</label>
                                <div class="col-md-3">
                                    <input id="skr_oznaka" name="skr_oznaka" type="text" value = "<?php echo $SkrOznaka;?>" placeholder="Skraćena oznaka države (format ABC)" class="form-control input-md" required><span class='asterisc'>*</span>
                                </div>
                            </div>
                            <!-- Dodao zapis -->
                            <div class="form-group">
