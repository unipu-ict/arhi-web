...
<?php    
    ...
    if($query)
        ...
        while($records = mysqli_fetch_array($query)){
            $IdZaharh = "$records[id_zaharh]";
            $Signatura = "$records[signatura]";
            $Oznaka = "$records[oznaka]";
            $Naziv = "$records[naziv]";
            $Tehjed = "$records[tehjed]";
            $OblikKor = "$records[oblik_kor]";
    ...
    //izmjene u bazi
    $sql = "update zahtjevnica_arhjed set
        signatura='".$Signatura."',
        oznaka='".$Oznaka."',    
        naziv='".$Naziv."',
        tehjed=".$Tehjed.",  
        oblik_kor='".$OblikKor."',
        addedby='".$AddedBy."',
        id_zahtjeva=".$IdZahtjeva."
        where id_zaharh='".$_GET['id']."' LIMIT 1";
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="page-header">
                <h2>Zahtjevnice za korištenje gradiva - gradivo: izmjeni zapis</h2>
            </div>
        </div>
    </div>
    <div class="container-fluid">
            ...
            <div class="panel panel-default-add">
                    ...
                    <form enctype="multipart/form-data" method="post" class="form-horizontal">
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-2">
                                    <input id="oznaka" name="oznaka" type="text" value="<?php echo $Oznaka;?>" placeholder="Oznaka arh. jedinice" class="form-control input-md" required=""><span class='asterisc'>*</span>
                                </div>
                            </div>
                            <!-- Naziv arh. jedinice -->
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <input id="naziv" name="naziv" type="text" value="<?php echo $Naziv;?>" placeholder="Naziv i vrijeme arh. jedinice" class="form-control input-md" required=""><span class='asterisc'>*</span>
                                </div>
                            </div>
                            <!-- Teh. jedinica -->
                            <div class="form-group">
                                ...
                                <div class="col-md-2">
                                    <input id="tehjed" name="tehjed" type="text" value="<?php echo $Oznaka;?>" placeholder="Oznaka teh. jedinice" class="form-control input-md" required=""><span class='asterisc'>*</span>
                                </div>
                            </div>
                            <!-- Oblik koristenja -->
                            <div class="form-group">
				...
				<select id="oblik_kor" name="oblik_kor" class="form-control" required="">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <input id="id_zahtjeva" name="id_zahtjeva" type="text" value="<?php echo $IdZahtjeva;?>" placeholder="ID zahtjeva" class="form-control input-md hide" required="">
                                </div>
                            </div>
                            <!-- Spremanje -->
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <a href = "../public_html/zahtjevnica_arhjed_list.php?id=<?php echo $IdZahtjeva?>"><input type = "button" value = "Poništi" class="btn btn-default" title="Natrag na listu"></a>
                                </div>
                            </div>
                            </div>
            </div>
