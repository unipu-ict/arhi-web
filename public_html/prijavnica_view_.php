                ...
                <div class="panel-body">
                    <form enctype="multipart/form-data" method="post" class="form-horizontal">
                        <fieldset>
                            ...
                            echo
                            '<div class="form-group"><label class="col-md-2 control-label">Gradivo:</label>
                            <table><tbody>';
                            while($records=mysqli_fetch_array($query)){
                                echo '<div class="col-md-3">
                                    <input value="HR-DAPA-'.$records['signatura'].', '.$records['naziv_fonda'].'" class="form-control input-md" readonly>
                                </div>';
                            }
                            ?>       
                            <?php
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <a href = "../public_html/prijavnica_list_.php"><input type = "button" value = "Poništi" class="btn btn-default" title="Natrag na listu"></a>
                                </div>
                            </div>
                            </div>
            </div>
