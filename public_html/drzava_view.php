   ...
   <div class="row">
        <div class="col-md-12">
            <div class="page-header">
                <h2>Šifarnik - države: pregledaj zapis</h2>
            </div>
        </div>
    </div>
    <div class="container-fluid">
                    ...
                    <form enctype="multipart/form-data" method="post" class="form-horizontal">
                        <fieldset>
                            ...
                            <label class="col-md-2 control-label" for="skr_oznaka">Skraćena oznaka:</label>
                                <div class="col-md-3">
                                    <input id="skr_oznaka" name="skr_oznaka" type="text" value = "<?php echo $SkrOznaka;?>" class="form-control input-md" readonly>
                                </div>
                            </div>
                            <!-- Dodao zapis -->
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <a href = "../public_html/drzava_list.php"><input type = "button" class="btn btn-primary" value ="Natrag na listu" class="btn btn-default" title="Natrag na listu"></a>
                                </div>
                            </div>
                            </div>
            </div>
