...
if (isset($_POST['submit'])){
    ...
    //unos u bazu
    $sql = "insert into svrha_ist (naziv,addedby)
        values ('$Naziv','$AddedBy')";
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="page-header">
                <h2>Šifarnik - svrha istraživanja: dodaj novi zapis</h2>
            </div>
        </div>
    </div>
    <div class="container-fluid">
                    ...
                    <form enctype="multipart/form-data" method="post" class="form-horizontal">
                        <fieldset>
                            ...
                            <label class="col-md-2 control-label" for="naziv">Naziv:</label>
                                <div class="col-md-2">
                                    <input id="naziv" name="naziv" type="text" placeholder="Naziv svrhe istraživanja" class="form-control input-md" required><span class='asterisc'>*</span>
                                </div>
                            </div>
                            <!-- Dodao zapis -->
                            <div class="form-group">
